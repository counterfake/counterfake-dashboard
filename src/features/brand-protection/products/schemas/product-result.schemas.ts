...
export const getProductResultsParamsSchema = z.object({
...
export const getProductResultsResponseSchema = z.object({
  data_count: z.number(),
  page_count: z.number(),
...
export const getProductResultsAnalysisParamsSchema = z.object({
  brand: z.string().optional(),
  parent_product: z.string().optional(),
  category: z.string().optional(),
  report: z.string().optional(),
...
export const getProductResultsAnalysisResponseSchema = z.object({
...
export const getProductResultsAnalysisMonthlyParamsSchema = z.object({
  brand: z.string().optional(),
...
export const getProductResultsAnalysisMonthlyResponseSchema = z.array(
  z.object({

...
import { useAnalyticsData } from "../dashboard-analytics/hooks/use-analytics-data";
import { useAnalyticsMonths } from "../dashboard-analytics/hooks/use-analytics-months";

import DashboardPageWrapper from "../components/dashboard-page-wrapper";

import { MonthlyAnalysisStats } from "../dashboard-analytics/components/monthly-analysis-stats/monthly-analysis-stats";
import { MonthlyRiskyClosedProducts } from "../dashboard-analytics/components/monthly-risky-closed-products/monthly-risky-closed-products";
import { Top10RiskySellers } from "../dashboard-analytics/components/top-10-risky-sellers/top-10-risky-sellers";
import { MonthlyRiskyClosedSellers } from "../dashboard-analytics/components/monthly-risky-closed-sellers/monthly-risky-closed-sellers";
import { TopRiskyCategories } from "../dashboard-analytics/components/top-risky-categories/top-risky-categories";
import { RiskyPlatforms } from "../dashboard-analytics/components/risky-platforms/risky-platforms";

export default function DashboardPage() {
  const mountsLogic = useAnalyticsMonths();
  const dataLogic = useAnalyticsData({

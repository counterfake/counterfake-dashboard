...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/common/components/ui/primitives/sheet";
...
const DEFAULT_SIDEBAR_COOKIE_MAX_AGE = 60 * 60 * 24 * 7;
  ...
  (
    {
      ...
      sidebarWidthMobile = DEFAULT_SIDEBAR_WIDTH_MOBILE,
    ...
    const setOpen = React.useCallback(
      ...
      [setOpenProp, open, sidebarCookieName, sidebarCookieMaxAge]
    );
